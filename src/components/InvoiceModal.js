        ...
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered>
          <div id="invoiceCapture">
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
              <div className="w-100">
                <h4 className="fw-bold my-2">{this.props.info.billTo || ''}</h4>
            ...
            <div className="p-4">
              <Row className="d-flex justify-content-between align-item-center mb-4">
                <Col md={4}>
                  <div className="fw-bold">Billed to:</div>
                  <div>{this.props.info.billTo || ''}</div>
                  <div>{this.props.info.billToAddress || ''}</div>
                  <div>{this.props.info.billToEmail || ''}</div>
                  <div className='mt-2'><span className='fw-bold'>Company GST:</span>{this.props.info.companyGst}</div>
                  <div className='mt-2'><span className='fw-bold'>Nature of Work:</span>{this.props.info.natureOfWork}</div>
                </Col>
                <Col md={4}>
                  <div className="mt-2">
                    <span className='fw-bold'>Invoice Date:&nbsp;</span>
                    <span>{this.props.info.dateOfIssue || ''}</span>
                  </div>
                  <div className="mt-2">
                    <span className='fw-bold'>Invoice No.:&nbsp;</span>
                    <span>{this.props.info.invoiceNumber || ''}</span>
                  </div>
                  <div className="mt-2">
                    <span className='fw-bold'>Vendor Code:&nbsp;</span>
                    <span>{this.props.info.vendorCode || ''}</span>
                  </div>
                  <div className="mt-2">
                    <span className='fw-bold'>WO No.:&nbsp;</span>
                    <span>{this.props.info.woNumber || ''}</span>
                  </div>
                  <div className="mt-2">
                    <span className='fw-bold'>PAN:&nbsp;</span>
                    <span>{this.props.info.vendorPan || ''}</span>
                  </div>
                  <div className="mt-2">
                    <span className='fw-bold'>GST:&nbsp;</span>
                    <span>{this.props.info.vendorGst || ''}</span>
                  </div>
                </Col>
              </Row>
